...
angular.module('myApp')
    ...
    .controller("PromotionCrudDialogCtrl", function($scope,$uibModal, $window, $uibModalInstance, promotionModel, $http) {
        ...
        if (vm.form.id_ !== 0) {
            getProductsByIds(vm.form.ProductIds);
        }
        ...
        function onProductAutocompleteSelected(product) {
            ...
            if (index !== -1) {
                ...
                var p = new ProductPromotionModel(product);
                p.PriceDiscount = p.Price - (p.Price * vm.form.Discount / 100).toFixed(0);
            ...
            $http({
                ...
                if (response.data.length > 0) {
                    angular.forEach(response.data, function(o) {
                        var product = new ProductPromotionModel(o);
                        product.PriceDiscount = product.Price - (product.Price * vm.form.Discount / 100).toFixed(0);
