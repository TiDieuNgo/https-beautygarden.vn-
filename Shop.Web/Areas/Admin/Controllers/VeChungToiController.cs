...
{
    [ShopAuthorize]
    public class VeChungToiController : BaseController
    {
        private readonly IMenuRepository _menuRepository;
        private readonly IUnitOfWork _unitOfWork;
        private const int pageSize = 20;
        public VeChungToiController(IMenuRepository menuRepository, IUnitOfWork unitOfWork)
        {
        ...
        public ActionResult Index(int? page)
        {
            ...
            IList<Menu> tags = _menuRepository.GetMany(o => o.Style == "ve-chung-toi" && o.idControl != 0).OrderBy(o => o.sPosition).ToList();
