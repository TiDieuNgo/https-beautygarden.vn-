...
{
     [ShopAuthorize]
    public class SubMenu1Controller : BaseController
    {
        ...
        public SubMenu1Controller(IMenuRepository menuRepository, IMenuProAddRepository menuProAddRepository,
        ...
        [HttpPost, ValidateInput(false)]
        public JsonResult SaveEditSubmenu1json(Menu model, int IdMenu, string NameProduct, int IPosition,string SEODescription,string SEOtitle)
        {
            //lay cha cua id san pham dang sua
            int idcha = _menuRepository.GetIdDanhMucCha(IdMenu);
