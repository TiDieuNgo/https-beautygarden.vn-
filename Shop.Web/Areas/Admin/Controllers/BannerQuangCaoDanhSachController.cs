...
{
    [ShopAuthorize]
    public class BannerQuangCaoDanhSachController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            var dl =
               _bannerDanhSachRepository.GetMany(o => o.BannerQCDanhSach);
